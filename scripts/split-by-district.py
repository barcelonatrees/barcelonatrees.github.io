#!/usr/bin/env python3
"""
Script para dividir el archivo GeoJSON de árboles por distritos de Barcelona.
...
def print_help():
    print("""
🌳 Divisor de GeoJSON por Distritos - Barcelonatrees
...
Resultado:
    - Crea un archivo .geojson por cada distrito de Barcelona
