const map = L.map('map').setView([41.382809, 2.177238], 13);
        ...
        for (let i = 0; i < data.features.length; i++) {
            ...
            if (feature.geometry && feature.geometry.coordinates) {
                ...
                marker.on('click', function() {
                    ...
                    // Only show details section if diameter or height is available
                    const hasDiameter = props.d || props.diameter;
                    const hasHeight = props.h || props.height;
